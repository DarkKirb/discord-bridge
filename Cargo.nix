...
in
{
  ...
  "registry+https://github.com/rust-lang/crates.io-index".clap."3.2.5" = overridableMkRustCrate (profileName: rec {
    ...
    version = "3.2.5";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "d53da17d37dba964b9b3ecb5c5a1f193a2762c700e6829201e645b9381c99dc7"; };
    features = builtins.concatLists [
      [ "atty" ]
      [ "clap_derive" ]
      [ "color" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".clap_derive."3.2.5" = overridableMkRustCrate (profileName: rec {
    ...
    version = "3.2.5";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "c11d40217d16aee8508cc8e5fde8b4ff24639758608e5374e731b53f85749fb9"; };
    features = builtins.concatLists [
      [ "default" ]
    ];
    dependencies = {
  ...
  "git+https://github.com/DarkKirb/matrix-sdk-statestore-sql".matrix-sdk-sql."0.1.0-beta.2" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCrateGit {
      ...
      name = "matrix-sdk-sql";
      version = "0.1.0-beta.2";
      rev = "20a909dd84e1c774e1a27f3a27b917bbc648cd7d";};
    features = builtins.concatLists [
      [ "bincode" ]
      [ "dashmap" ]
      [ "e2e-encryption" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".sqlx."0.6.0" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.6.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "1f82cbe94f41641d6c410ded25bbf5097c240cefdf8e3b06d04198d0a96af6a4"; };
    features = builtins.concatLists [
      [ "_rt-tokio" ]
      [ "default" ]
      [ "macros" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".sqlx-core."0.6.0" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.6.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "6b69bf218860335ddda60d6ce85ee39f6cf6e5630e300e19757d1de15886a093"; };
    features = builtins.concatLists [
      [ "_rt-tokio" ]
      [ "_tls-rustls" ]
      [ "any" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".sqlx-macros."0.6.0" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.6.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "f40c63177cf23d356b159b60acd27c54af7423f1736988502e36bae9a712118f"; };
    features = builtins.concatLists [
      [ "_rt-tokio" ]
      [ "hex" ]
      [ "migrate" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".sqlx-rt."0.6.0" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.6.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "874e93a365a598dc3dadb197565952cb143ae4aa716f7bcc933a8d836f6bf89f"; };
    features = builtins.concatLists [
      [ "_rt-tokio" ]
      [ "_tls-rustls" ]
      [ "once_cell" ]
